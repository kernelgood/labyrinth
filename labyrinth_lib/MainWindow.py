...
class LabyrinthWindow (gobject.GObject):
    ...
    def create_menu (self):
        actions = [
                ('FileMenu', None, _('Файл')),
                ('Export', None, _('Сохранить как рисунок'), None,
                 _("Export your map as an image"), self.export_cb),
                ('ExportMap', gtk.STOCK_SAVE_AS, _('Сохранить для редактирования'), '<control>S',
                ...
                ('EditMenu', None, _('_Правка')),
                ('ViewMenu', None, _('_Вид')),
                ('ShowToolbars', None, _('_Пункты меню')),
                ...
                ('LinkThoughts', None, _("Этот пункт пока не работает"), '<control>L',
                _("Link the selected thoughts"), self.link_thoughts_cb),
                ('ModeMenu', None, _('_Режим')),
        ...
        self.radio_actions = [
                ('Edit', gtk.STOCK_EDIT, _('_Режим редактирования'), '<control>E',
                 _('Режим редактирования'), MMapArea.MODE_EDITING),
                 ('AddImage', gtk.STOCK_ADD, _('_Добавить изображение'), None,
                 _('Вставить изображение'), MMapArea.MODE_IMAGE),
                 ('Drawing', gtk.STOCK_COLOR_PICKER, _('_Режим рисования'), None,
                 _('Режим рисования'), MMapArea.MODE_DRAW)]
        self.view_radio_actions = [
                ('UseBezier', None, _('Использовать _кривые'), None,
                 _('Use curves as links'), MMapArea.VIEW_BEZIER),
                 ('UseLines', None, _('Использовать _линии'), None,
                 _('Use straight lines as links'), MMapArea.VIEW_LINES)]
        self.toggle_actions = [
                ('ViewExtend', None, _('_Дополнительная информация'), None,
                 _('Show extended information for thoughts'), self.view_extend_cb),
                ('ShowMainToolbar', None, _('_Панель инструментов'), None,
                 _('Show main toolbar'), self.show_main_toolbar_cb),
                ('ShowFormatToolbar', None, _('_Формат ввода'), None,
    ...
    def title_changed_cb (self, widget, new_title):
        self.title_cp = self.title_cp = _('Новая карта')
        if new_title != '':
    ...
    def export_map_cb(self, event):
        chooser = gtk.FileChooserDialog(title=_("Сохранить для редактирования"), action=gtk.FILE_CHOOSER_ACTION_SAVE, \
