...
AUTHORS = ['Abrashin Daniil <kernelgood@gmail.com>', 'Don Scorgie <Don@Scorgie.org>',
...
"\nLabyrinth/Лабиринт — это свободное программное обеспечение(СПО), вы можете "
"свободно распространять его и изменять в соответствии с условиями лицензии GNU "
"GPL от Фонда СПО. "
"\n\n"
"Программа создана с надеждой, что она будет кому-нибудь полезна, но "
"без каких-либо гарантий, что она заработает и будет работать правильно. "
"\n\n"
"\nIn English"
"\n\n"
"Labyrinth is free software; you can redistribute it and/or modify "
...
"59 Temple Place, Suite 330, Boston, MA  02111-1307  USA")
    ...
    def delete_clicked (self, button):
        ...
        dialog = gtk.MessageDialog (self, gtk.DIALOG_MODAL, gtk.MESSAGE_WARNING, gtk.BUTTONS_YES_NO,
                                                                _("Действительно хотите удалить эту карту?"))
        resp = dialog.run ()
        dialog.hide ()
        del (dialog)
    ...
    def import_clicked(self, button, other=None, *data):
        chooser = gtk.FileChooserDialog(title=_("Открыть файл"), action=gtk.FILE_CHOOSER_ACTION_OPEN, \
    ...
    def populate_view (self):
        ...
        column = gtk.TreeViewColumn(_("Название карты"), cellrenderer,
                                                                text=self.COL_TITLE)
        ...
        col1 = gtk.TreeViewColumn (_("Последнее изменение"), gtk.CellRendererText(),
